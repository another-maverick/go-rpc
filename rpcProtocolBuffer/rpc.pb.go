...
func init() {
	proto.RegisterType((*RpcRequest)(nil), "rocProtocolBuffer.rpcRequest")
	proto.RegisterType((*RpcResponse)(nil), "rocProtocolBuffer.rpcResponse")
}
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x2c, 0xca, 0x4f, 0x0e, 0x00, 0xb1, 0x92, 0xf3, 0x73,
	0x9c, 0x4a, 0xd3, 0xd2, 0x52, 0x8b, 0x94, 0x14, 0xb8, 0xb8, 0x8a, 0x0a, 0x92, 0x83, 0x52, 0x0b,
	...
	0xf5, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x07, 0xad, 0x63, 0xe3, 0xca, 0x00, 0x00, 0x00,
}
...
func (c *testRpcClient) TestRpc(ctx context.Context, in *RpcRequest, opts ...grpc.CallOption) (*RpcResponse, error) {
	out := new(RpcResponse)
	err := c.cc.Invoke(ctx, "/rocProtocolBuffer.testRpc/TestRpc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestRpc_TestRpc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rocProtocolBuffer.testRpc/TestRpc",
	}
...
var _TestRpc_serviceDesc = grpc.ServiceDesc{
	ServiceName: "rocProtocolBuffer.testRpc",
